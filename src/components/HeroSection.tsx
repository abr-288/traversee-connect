...
import { Hotel, Map, Car, Plane, Calendar as CalendarIcon, Users, Search } from "lucide-react";
      ...
      <div className="container relative z-10 mx-auto px-4 py-16">
        ...
        <div className="max-w-5xl mx-auto bg-background rounded-2xl shadow-2xl p-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid w-full grid-cols-4 lg:grid-cols-6 mb-6 h-auto p-1 bg-muted">
